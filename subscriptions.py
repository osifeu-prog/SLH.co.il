"""
SLH AI Spark Ã—Â³Ã‚Â³Ã—â€™Ã¢â€šÂ¬Ã¢â€žÂ¢Ã—Â³Ã¢â‚¬â„¢Ã—â€™Ã¢â€šÂ¬Ã‚Å¡Ã–Â²Ã‚Â¬Ã—Â³Ã¢â‚¬â„¢Ã—â€™Ã¢â‚¬Å¡Ã‚Â¬Ã–Â²Ã‚Â Subscription DB layer.
...
# Phase B mirror Ã—Â³Ã‚Â³Ã—â€™Ã¢â€šÂ¬Ã¢â€žÂ¢Ã—Â³Ã¢â‚¬â„¢Ã—â€™Ã¢â€šÂ¬Ã‚Å¡Ã–Â²Ã‚Â¬Ã—Â³Ã¢â‚¬â„¢Ã—â€™Ã¢â‚¬Å¡Ã‚Â¬Ã–Â²Ã‚Â bot pushes state to slh-api Postgres so the Mini App
...
async def init_db() -> None:
    ...
    if not os.path.exists(MIGRATION_FILE):
        # Embedded fallback Ã—Â³Ã‚Â³Ã—â€™Ã¢â€šÂ¬Ã¢â€žÂ¢Ã—Â³Ã¢â‚¬â„¢Ã—â€™Ã¢â€šÂ¬Ã‚Å¡Ã–Â²Ã‚Â¬Ã—Â³Ã¢â‚¬â„¢Ã—â€™Ã¢â‚¬Å¡Ã‚Â¬Ã–Â²Ã‚Â keeps the bot bootable even if file is missing
...
async def _mirror_to_pg(sub: SubscriptionRow) -> None:
    ...
    Never raises Ã—Â³Ã‚Â³Ã—â€™Ã¢â€šÂ¬Ã¢â€žÂ¢Ã—Â³Ã¢â‚¬â„¢Ã—â€™Ã¢â€šÂ¬Ã‚Å¡Ã–Â²Ã‚Â¬Ã—Â³Ã¢â‚¬â„¢Ã—â€™Ã¢â‚¬Å¡Ã‚Â¬Ã–Â²Ã‚Â SQLite stays canonical for quota.check (latency-sensitive).
...
async def mrr_ils() -> float:
    """Monthly recurring revenue: sum of active paid subscriptions Ã—Â³Ã‚Â³Ã–Â²Ã‚Å¸Ã—Â²Ã‚Â²Ã–Â²Ã‚Â¿Ã—Â²Ã‚Â²Ã–Â²Ã‚Â½- tier price."""
    async with aiosqlite.connect(DB_PATH) as db:
        cur = await db.execute(
