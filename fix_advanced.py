...
# â”€â”€â”€ 2. GUIDE CALLBACK ×ž×•×¨×—×‘ (×ª×™×§×•×Ÿ ×”×ž×—×¨×•×–×•×ª) â”€â”€â”€
...
new_guide_cb = '@dp.callback_query(F.data.startswith("guide_"))\n' \
    ...
    '    d = callback.data\n' \
    '    topics = {\n' \
    '        "guide_points": "â­ Earn points: /checkin daily, /tap, complete tasks.",\n' \
    '        "guide_deposit": "ðŸ’Ž Deposit TON: send TON to the wallet with your Telegram ID in memo.",\n' \
    '        "guide_tier": "ðŸ† Tiers: Free (x1.0), Pro (9.9 TON) x1.5, Business (29 TON) x2.0.",\n' \
    '        "guide_vip": "ðŸ‘¥ VIP Groups: Free: https://t.me/+HIzvM8sEgh1kNWY0, VIP (18 ): https://t.me/+KLKB9-JdO85kNWJk. Join VIP: /vip",\n' \
    '        "guide_signals": "ðŸ“ˆ Trading Signals: VIP members get daily market analysis, entry/exit points, risk tips. Join VIP: /vip"\n' \
    '    }\n' \
    '    await callback.message.answer(topics.get(d, "Unknown"))\n' \
    '    await callback.answer()'
...
print("âœ… Advanced features added (fixed).")
