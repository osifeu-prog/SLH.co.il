...
Public endpoints:
  POST /api/pancakeswap/link-wallet   ג€” user links their BSC wallet to user_id
  GET  /api/pancakeswap/recent-swaps  ג€” last N swaps on the SLH/WBNB pair
  POST /api/pancakeswap/scan           ג€” force-scan recent blocks (admin-triggered)
  GET  /api/pancakeswap/user/{user_id}/swaps ג€” swaps attributed to this user
