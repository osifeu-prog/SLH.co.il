...
- [ ] Fix Railway deployment (Agent usage limit)
/task Reactivate other Telegram bots
/task Reconnect ESP32 devices
/task Verify slh-nft.com integration
/task Set up comprehensive monitoring  _(added 2026-05-16 12:51 via bot)_
- [ ] # Smoke Test – SLH Ecosystem

## 1. בדיקת בוט בסיסי
- [ ] שליחת /start – מקבל הודעה.
- [ ] שליחת /menu – רואה תפריט.
- [ ] שליחת /crypto – מקבל מחירים (BTC/ETH).
- [ ] שליחת /guide – מקבל מדריך.
- [ ] שליחת /donate – מקבל כתובות קריפטו.
- [ ] שליחת /tasks – מקבל את תוכן TASK_BOARD.md.
- [ ] שליחת /task <משימה חדשה> – מוסיף ומציג אישור.

## 2. בדיקת AI
- [ ] שליחת "מה שלומך?" – מקבל תשובה (Groq או fallback).
- [ ] אם Groq מחזיר 429 – ממתין 15 דקות או מחליף מפתח.

## 3. בדיקת פקודות עורך
- [ ] /ls ../ops – רשימת קבצים.
- [ ] /cat ../ops/TASK_BOARD.md – תוכן.
- [ ] /grep "Railway" ../ops – חיפוש.

## 4. בדיקת API (אחרי החלפת Railway)
- [ ] /price – מחזיר מחירי SLH/MNH/ZVK.
- [ ] /devices – רשימת ESP32.
- [ ] /control – סיכום מערכת.

## 5. בדיקת שירות Windows
- [ ] nssm status SLH_Bot – running.
- [ ] הפעלה מחדש של המחשב – הבוט עולה אוטומטית.  _(added 2026-05-16 13:13 via bot)_
- [ ] Publish bot for donations
/task Add Guardian integration
/task Fix Railway API or migrate to free service
/task Enable /tasks command (fix handler)
/task Troubleshoot Groq rate limit  _(added 2026-05-16 13:15 via bot)_
