                [types.InlineKeyboardButton(text=f"?—?¨?—â€??—â€¢?—?© ?—â€™?—â„¢?—?©?—â€? ?—â€?-{PRICE_ILS} ?—?©\"?—â€”", callback_data="buy_now")]
            ]
        )
...
async def buy_now(callback: types.CallbackQuery):
    ...
    await callback.answer("?—â€??—?§?—?©?—?¾ ?—?¾?—?©?—?“?—â€¢?—â€Œ ?—? ?—?¤?—?¾?—â€”?—â€?")
...
async def approve_cmd(message: types.Message):
    if message.from_user.id != ADMIN_ID:
        await message.answer("?—?¯?—â„¢?—?? ?—â€??—?¨?—?©?—?¯?—â€?.")
        return

    parts = (message.text or "").split()
    if len(parts) != 2 or not parts[1].isdigit():
        await message.answer("?—?©?—â„¢?—â€??—â€¢?—?© ?—? ?—â€??—â€¢?—??: /approve <user_id>")
        return

    target_id = int(parts[1])
    approve_user(target_id)
    await message.answer(f"?—â€??—â€??—?©?—?¾?—â€??—?© {target_id} ?—?¯?—â€¢?—?©?—?¨")
    ...
    try:
        ...
        await message.answer(f"?—?“?—?¯ ?—? ?—â„¢?—?¾?—?? ?—â€??—â„¢?—â€? ?—?“?—?©?—?“?—â€¢?—â€” ?—â€??—â€¢?—â€œ?—?¢?—â€? ?—?“?—â€??—?©?—?¾?—â€??—?©: {e}")
...
async def reject_cmd(message: types.Message):
    ...
    parts = (message.text or "").split()
    if len(parts) != 2 or not parts[1].isdigit():
        await message.answer("?—?©?—â„¢?—â€??—â€¢?—?© ?—? ?—â€??—â€¢?—??: /reject <user_id>")
        return

    target_id = int(parts[1])
    reject_user(target_id)
    await message.answer(f"?—â€??—â€??—?©?—?¾?—â€??—?© {target_id} ?—? ?—â€œ?—â€”?—â€?")

    try:
        await bot.send_message(target_id, "?—â€??—?§?—?©?—?¾ ?—â€??—?¾?—?©?—?“?—â€¢?—â€Œ ?—? ?—â€œ?—â€”?—?¾?—â€?. ?—?¯?—?¤?—?©?—?¨ ?—?“?—?©?—?“?—â€¢?—â€” BUY ?—â€??—â€”?—â€œ?—?© ?—â€¢?—?“?—?¤?—?¾?—â€¢?—â€” ?—â€??—?§?—?©?—â€? ?—â€”?—â€œ?—?©?—â€?.")
    except Exception as e:
        await message.answer(f"?—?“?—?¯ ?—? ?—â„¢?—?¾?—?? ?—â€??—â„¢?—â€? ?—?“?—?©?—?“?—â€¢?—â€” ?—â€??—â€¢?—â€œ?—?¢?—â€? ?—?“?—â€??—?©?—?¾?—â€??—?©: {e}")
...
async def status_cmd(message: types.Message):
    ...
    parts = (message.text or "").split()
    if len(parts) != 2 or not parts[1].isdigit():
        await message.answer("?—?©?—â„¢?—â€??—â€¢?—?© ?—? ?—â€??—â€¢?—??: /status <user_id>")
        return
...
async def catch_all(message: types.Message):
    ...
    if is_paid(message.from_user.id):
        await message.answer("?—â€??—â€™?—â„¢?—?©?—â€? ?—?©?—?“?—?‘ ?—?¤?—?¢?—â„¢?—?“?—â€?.")
    elif has_pending_request(message.from_user.id):
        await message.answer(PENDING_TEXT)
    else:
        await message.answer("?—â€??—â€œ?—â„¢ ?—?“?—?¤?—?¾?—â€¢?—â€” ?—â€??—?§?—?©?—?¾ ?—?¾?—?©?—?“?—â€¢?—â€Œ ?—?©?—?“?—â€” BUY.")
