...
# -----------------------------------
PLANS = {
    "m1": {"name": "????? ?????", "monthly": 4, "apy": 48, "lock": 30, "min": 1},
    "m3": {"name": "????? ??????", "monthly": 4.5, "apy": 55, "lock": 90, "min": 5},
    "m6": {"name": "????? ???-????", "monthly": 5, "apy": 60, "lock": 180, "min": 10},
    "y1": {"name": "????? ????", "monthly": 5.4, "apy": 65, "lock": 365, "min": 25},
}
